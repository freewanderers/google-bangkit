...
def main():
    ...
    csv_file_location = '/home/student-01-c9a4a35ca9eo/data/user_emails.csv'
    report_file = '/home/student-01-c9a4a35ca9eo/data' + '/updated_user_emails.csv'
    user_email_list = []
